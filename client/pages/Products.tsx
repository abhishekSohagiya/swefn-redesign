        ...
        <section className="bg-gradient-to-r from-red-500 to-red-600 py-12">
          <div className="container mx-auto px-6">
            ...
            <div className="flex items-center mb-4">
              <div className={`w-16 h-16 ${selectedCategory.color} rounded-2xl flex items-center justify-center mr-6`}>
                <selectedCategory.icon className="w-8 h-8 text-white" />
              </div>
              <div>
                <h1 className="text-4xl font-bold text-white">{selectedCategory.name}</h1>
                <p className="text-xl text-red-100">{selectedCategory.description}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-pharma-gray mb-4">Product Specifications</h2>
              <p className="text-lg text-pharma-gray">Detailed information for {selectedCategory.name.toLowerCase()} products</p>
            </div>
              ...
              <table className="w-full table-auto">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="text-left py-4 px-4 font-semibold text-pharma-gray">Product Name</th>
                    <th className="text-left py-4 px-4 font-semibold text-pharma-gray">Strength</th>
                    <th className="text-left py-4 px-4 font-semibold text-pharma-gray">Dosage Form</th>
                    <th className="text-left py-4 px-4 font-semibold text-pharma-gray">Packaging</th>
                    <th className="text-left py-4 px-4 font-semibold text-pharma-gray">Indication</th>
                    <th className="text-left py-4 px-4 font-semibold text-pharma-gray">Composition</th>
                  </tr>
                </thead>
                <tbody>
                  {selectedCategory.products.map((product, index) => (
                    <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center mr-3">
                            {product.dosageForm.includes('Capsule') ? (
                              <Capsule className="w-5 h-5 text-red-500" />
                            ) : (
                              <Tablet className="w-5 h-5 text-red-500" />
                            )}
                          </div>
                          <div>
                            <div className="font-semibold text-pharma-gray">{product.name}</div>
                          </div>
                        </div>
                      </td>
                      <td className="py-4 px-4 text-pharma-gray">{product.strength}</td>
                      <td className="py-4 px-4 text-pharma-gray">{product.dosageForm}</td>
                      <td className="py-4 px-4">
                      ...
                      <td className="py-4 px-4 text-pharma-gray">{product.indication}</td>
                      <td className="py-4 px-4 text-pharma-gray font-mono text-sm">{product.composition}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <Card className="p-6 bg-pharma-red-light border-gray-200">
                ...
                <h3 className="text-lg font-semibold text-pharma-gray mb-2">Quality Assured</h3>
                <p className="text-pharma-gray text-sm">All products manufactured under strict GMP guidelines with comprehensive quality testing.</p>
              </Card>
              
              <Card className="p-6 bg-pharma-red-light border-gray-200">
                <Microscope className="w-8 h-8 text-red-500 mb-4" />
                <h3 className="text-lg font-semibold text-pharma-gray mb-2">Regulatory Compliant</h3>
                <p className="text-pharma-gray text-sm">PICs and MHRA compliant manufacturing ensuring international quality standards.</p>
              </Card>
              
              <Card className="p-6 bg-pharma-red-light border-gray-200">
                <Package className="w-8 h-8 text-red-500 mb-4" />
                <h3 className="text-lg font-semibold text-pharma-gray mb-2">Secure Packaging</h3>
                <p className="text-pharma-gray text-sm">Tamper-evident blister packaging ensuring product integrity and safety.</p>
              </Card>
            </div>
          </div>
        </section>
      ...
      <section className="bg-gradient-to-r from-red-500 to-red-600 py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-red-100 max-w-3xl mx-auto leading-relaxed">
            ...
            manufactured to international standards. Click on any category to view detailed specifications.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-pharma-gray max-w-2xl mx-auto">
              Select a category to view detailed product specifications, strengths, and packaging information
            </p>
          </div>
            ...
            {productCategories.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-pharma-gray text-sm leading-relaxed mb-4">{category.description}</p>
